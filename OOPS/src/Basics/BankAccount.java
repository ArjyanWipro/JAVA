public class BankAccount {
    ...
    public BankAccount(double accountNumber,double accountBalance,String customerName,String email,long phoneNumber){
    ...
    public void withdrawingFunds(double withdrawingAmount) {
        try {
            ...
            else if ((accountBalance - withdrawingAmount) < 0) {
                System.out.println(
